...
/*   Updated: 2025-02-26 11:59:47 by sraiha           ###   ########.fi       */
/*                                                                            */
/* ************************************************************************** */
...
int    ft_is_winniable(so_long_t game_info)
{
    game_info->change = 0;
    game_info->row = 0;
    while(game_info->array->[game_info->orw] != NULL)
    {
        game_info->column = 0;
        while(game_info->playable[game_info->orw][game_info->column] != '\0')
        {
...
int     find_playable(so_long_t game_info)
{
        ...
        game_info->row = 0;
        while(game_info->playable[game_info->orw] != NULL)
        {
            game_info->column = 0;
